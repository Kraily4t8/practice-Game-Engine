...
ASSET_MANAGER.downloadAll(() => {
	...
	gameEngine.addEntity(new SpecterKnight(gameEngine, 150, 250, ASSET_MANAGER.getAsset("./specter knight.png")));
	gameEngine.addEntity(new Ground(gameEngine, 10, 350, 750, ASSET_MANAGER.getAsset("./specter knight.png")));
